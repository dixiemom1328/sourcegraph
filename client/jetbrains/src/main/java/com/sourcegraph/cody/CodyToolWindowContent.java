...
public class CodyToolWindowContent implements UpdatableChat {
  ...
  public CodyToolWindowContent(@NotNull Project project) {
    ...
    var codebaseSelector = new CodebaseSelector(project);
    controlsPanel.add(promptPanel, BorderLayout.NORTH);
    controlsPanel.add(sendButton, BorderLayout.CENTER);
    var codebaseSelectorPanel = new JPanel(new BorderLayout());
    codebaseSelectorPanel.add(new Label("Codebase: "), BorderLayout.WEST);
    codebaseSelectorPanel.add(codebaseSelector, BorderLayout.CENTER);
    controlsPanel.add(codebaseSelectorPanel, BorderLayout.SOUTH);

...
var (
	...
	repoDequeueCooldown = env.Get("CODEINTEL_AUTOINDEXING_", "1d", "How soon a repository should be on cooldown after a successful index before it can be a candidate when the most recently queued job is outside the lookback window.")
)
